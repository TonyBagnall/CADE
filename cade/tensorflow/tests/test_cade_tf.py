...
from cade.tensorflow import CADELoss, cade_alignment_matrix, cade_grad_x
from cade.tensorflow.tests._utils import check_arrays_close, check_values_close
...
def test_cade_alignment_matrix_equivalence(gamma, c):
    ...
    E_tf, s_tf = cade_alignment_matrix(x, y, c=c, gamma=gamma)
...
def test_cade_grad_x_equivalence(gamma, c):
    ...
    dx_tf, s_tf = cade_grad_x(x, y, c=c, gamma=gamma)
